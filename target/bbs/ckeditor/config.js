...
CKEDITOR.editorConfig = function( config ) {
	...
	config.filebrowserBrowseUrl = '/bbs/ckfinder/ckfinder.html';
	config.filebrowserImageBrowseUrl = '/bbs/ckfinder/ckfinder.html?type=Images';
    config.filebrowserFlashBrowseUrl = '/bbs/ckfinder/ckfinder.html?type=Flash';
